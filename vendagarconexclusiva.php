<script type="text/javascript">
   ...
   if (confirm ("Deseja marcar este item como entregue?")){   
		...
		//window.location="?btn=vendagarconexclusiva";
		return false;
    }
    
    function confirmariten(query){
    if (confirm ("Deseja exluir este item?")){   
		window.location="inicio2.php" + query;  
		return true;
    }
    else  
		//window.location="inicio2.php?btn=vendagarconexclusiva";
		return false;
    }
</script>
   ...
   <div class="bs-docs-section" >
      <div>
         ...
         <?php 
            ...
            echo "<meta HTTP-EQUIV='refresh' CONTENT='5;URL=?btn=vendagarconexclusiva'>";
            if(@$_GET['acao'] == "mudar"){
            	$id = $_GET['id'];
             ...
             if(@$_GET['retira'] == "produto"){
            	...
            	if($del == 1){
            	print "<META HTTP-EQUIV=REFRESH CONTENT='0; URL=inicio2.php?btn=vendagarconexclusiva'>";	
            	}
            }
            ?>
		<p> LEGENDA <br/> <br/>
         ...
         <table class="table table-striped table-bordered">
            ...
            <?php 
               ...
               $sql = mysql_query("SELECT * FROM tbl_carrinho INNER JOIN garcon ON tbl_carrinho.idGarcon = garcon.idGarcon WHERE status='0' AND tbl_carrinho.idGarcon = '$idGarcon' ORDER BY id DESC") or die(mysql_error());
               $i = 0;
            ...
            <tr>
               ...
               <td align="center">
				...
				<?php ?>
                  <?php } ?>
				  <td align="center">
						<a href="javascript:confirmariten('?btn=vendagarconexclusiva&retira=produto&id=<?php echo $ver['id'] ?>entregue=1')"><img src="imagens/excluir.png" width="20" height="20" border="0" /></a> 
						<a href="javascript:confirmardel('?btn=vendagarconexclusiva&acao=mudar&id=<?php echo $ver['id']; ?>&entregue=1')">
