...
<table width="340" border="0" align="center" class="inputs">
 ...
 $somatotal = $_GET['somatotal'];
  ...
  <tr>
	<td align="center">Mesa nº: <?php echo $id_mesa ?></td>
  </tr>
    <tr>
    <td><hr/></td>
    </tr>
	  ...
	  <td colspan="4" align="center" class="btn"><br/>
		...
		<?php 
			If ($_SESSION['nv_garcom'] == '0')
				...
				echo "<button type='button' onclick='confirma();' >Fechar mesa</button>	";
		?>
	  
		<button type="button" onclick="window.print();" />Imprimir conta</button>
	</td>
  </tr>   
    </table>
 <br/>
