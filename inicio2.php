...
####  verificando se a session existe ou nao #####
...
<div id="menu"><center><?php include "menu2.php"?></center></div></div>
...
<div id="geral">
	...
	<?php 
		...
		elseif($_GET['btn'] == "mesasexclusiva"){

			include "mesasexclusiva.php";
		...
		elseif($_GET['btn'] == "vendagarconexclusiva"){

			include "vendagarconexclusiva.php";
